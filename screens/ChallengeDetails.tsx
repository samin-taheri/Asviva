    ...
    return(
        <View style={styles.container}>
          ...
          <ColoredCards2  
           ...
           <Graph title={'Route Info'} width={340} height={170} barPercentage={0.6}/>
           </View>
          </ScrollView>
          </ImageBackground>
          </View>
